...
async def play(hostname, port, game_id,power_name, tf_port, tf_host):
    ...
    dipnet_player = DipNetSLPlayer(port=tf_port, hostname=tf_host)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tf_port', type=int)
    parser.add_argument('--tf_host', type=str)
    ...
    asyncio.run(play(hostname=host, port=port, game_id=game_id,power_name=power, tf_port=tf_port, tf_host=tf_host))
